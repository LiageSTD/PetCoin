...
public class Unnest extends TableImpl<UnnestRecord> {
     ...
     */
    @Deprecated
    public final TableField<UnnestRecord, Object> UNNEST_ = createField(DSL.name("unnest"), DefaultDataType.getDefaultDataType("\"anyrange\""), this, "");

    private Unnest(Name alias, Table<UnnestRecord> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anymultirange\""))
        });
    }
    ...
    public Unnest call(
        ...
        Unnest result = new Unnest(DSL.name("unnest"), null, new Field[] {
            DSL.val(__1, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anymultirange\""))
        });
