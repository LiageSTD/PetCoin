...
import org.coinpet.petcoin.crypto.repository.jooq.model.public_.tables.NotificationLogs.NotificationLogsPath;
import org.coinpet.petcoin.crypto.repository.jooq.model.public_.tables.Subscriptions.SubscriptionsPath;
...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, Long> TELEGRAM_ID = createField(DSL.name("telegram_id"), SQLDataType.BIGINT, this, "");
    ...
    public NotificationLogsPath notificationLogs() {
        if (_notificationLogs == null)
            _notificationLogs = new NotificationLogsPath(this, null, Keys.NOTIFICATION_LOGS__NOTIFICATION_LOGS_USER_ID_FKEY.getInverseKey());
     ...
     * <code>public.cryptocurrencies</code> table
     */
    public CryptocurrenciesPath cryptocurrencies() {
        return subscriptions().cryptocurrencies();
    }
