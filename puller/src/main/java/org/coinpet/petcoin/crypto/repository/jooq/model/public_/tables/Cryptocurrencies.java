...
import org.coinpet.petcoin.crypto.repository.jooq.model.public_.tables.CryptoExchange.CryptoExchangePath;
import org.coinpet.petcoin.crypto.repository.jooq.model.public_.tables.MarketData.MarketDataPath;
...
public class Cryptocurrencies extends TableImpl<CryptocurrenciesRecord> {
    ...
    public List<UniqueKey<CryptocurrenciesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.CRYPTOCURRENCIES_NAME_KEY, Keys.CRYPTOCURRENCIES_SYMBOL_KEY);
    }
